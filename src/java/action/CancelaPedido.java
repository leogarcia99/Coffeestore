 ...
 * @author LEONARDO
 */
public class CancelaPedido extends ActionSupport{
    ...
    public int IDusuario, totalApagar, IDPEDIDO;
    ...
    Connection cnx  = null;
        ...
        try{
            ...
            String sql = "UPDATE pedidos set estado ='Cancelado', btnCancelar = 'hidden', btnentregar='hidden', btnenvio ='hidden' where id_pedido = ? ;";
