 ...
 * @author LEONARDO
 */
public class guardaCarrito extends ActionSupport{
    ...
    Connection cnx  = null;
        ...
        try{
            ...
            String sql = "INSERT INTO carritos VALUES(0,?,?,?,?,?,?)";
            pstm = cnx.prepareStatement(sql);
            
          
            pstm.setInt(1, inputidp);
            pstm.setInt(2, inputidu);
            pstm.setString(3, inputname);
            pstm.setInt(4, inputprecio);
            pstm.setInt(5, inputcantidad);
            pstm.setInt(6, total);
